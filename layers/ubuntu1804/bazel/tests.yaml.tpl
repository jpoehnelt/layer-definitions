...
#   command: 'wget'
#   args: ['--version']
#   expectedOutput: ['GNU Wget.* built on linux-gnu.*']  # wget: error while loading shared libraries: libssl.so.1.0.0: cannot open shared object file: No such file or directory
- name: 'check-file'
  command: 'file'
  args: ['--version']
  expectedOutput: ['file-*']
